 ...
 * @BaseSixtyTwo tells CDI container to instantiate interface type with this class when annotated 
 */

@BaseSixtyTwo
@ApplicationScoped
public class UrlShortenerUtil_Base62 implements UrlShortenerUtil  {
